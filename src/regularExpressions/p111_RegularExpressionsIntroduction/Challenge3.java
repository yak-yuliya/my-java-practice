package regularExpressions.p111_RegularExpressionsIntroduction;
...
//            while(matcher8.find()) {
//                System.out.println("Occurrence: " + matcher8.group(pack1));
//            }
//
...
//            while(matcher9.find()) {
//                System.out.println("Occurrence: " + matcher9.group(pack1));
//            }
//
...
//                System.out.println("Occurrence: start = " + matcher10.start(pack1) + " end = " + (matcher10.end(pack1) -pack1));
//            }
//
//            String challenge11 = "{0, 2}, {0, 5}, {pack1, 3}, {2, 4}";
//            Pattern pattern11 = Pattern.compile("\\{(.+?)\\}");
//            Matcher matcher11 = pattern11.matcher(challenge11);
//            while(matcher11.find()) {
//                System.out.println("Occurrence: " + matcher11.group(pack1));
//            }
//            System.out.println("*********************");
//
//            String challenge11a = "{0, 2}, {0, 5}, {pack1, 3}, {2, 4} {x, y}, {6, 34}, {11, 12}";
//            Pattern pattern11a = Pattern.compile("\\{(\\d+, \\d+)\\}");
//            Matcher matcher11a = pattern11a.matcher(challenge11a);
//            while(matcher11a.find()) {
//                System.out.println("Occurrence: " + matcher11a.group(pack1));
//            }
